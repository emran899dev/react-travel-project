...
import cox from '../images/Image/Sajek.png'
            ...
            <div className="row">
                {
                     clicked === false && <div className="col-md-5 text-light banner-text">
                                            ...
                                            <Button variant="warning" style={{ marginTop: '5%',backgroundColor:'#F9A51A',color:'black'}}>Booking </Button>
                                        </div>
                }
                {
                ...
                
                {
                    clicked === false && cities.map(city => <div className="col-md-2" onClick={()=>handleCity(city,true)}>
                            ...
                            <h3 style={{fontSize: '20px'}}>{city.name}</h3>
                            </div>
                        </div>
                    )
                }
